/*
package android.aqita.com.aqitapartners;
...
public class HomeActivity extends AppCompatActivity
        implements NavigationView.OnNavigationItemSelectedListener, MessageCommunicator, MobiComKitActivityInterface, GoogleApiClient.ConnectionCallbacks, GoogleApiClient.OnConnectionFailedListener, LocationListener {
    ...
    public void showErrorMessageView(String message) {
        ...
        TextView textView = (TextView) group.findViewById(com.applozic.mobicomkit.uiwidgets.R.id.snackbar_action);
        textView.setTextColor(Color.YELLOW);
        group.setBackgroundColor(getResources().getColor(com.applozic.mobicomkit.uiwidgets.R.color.error_background_color));
        TextView txtView = (TextView) group.findViewById(com.applozic.mobicomkit.uiwidgets.R.id.snackbar_text);
...
//            getFragmentManager().beginTransaction().add(R.id.home_container, new ChatFragment()) ;
        ...
        InstructionUtil.showInfo(this, com.applozic.mobicomkit.uiwidgets.R.string.info_message_sync, BroadcastService.INTENT_ACTIONS.INSTRUCTION.toString());
...
//            startActivity(intent);
            ...
            getSupportFragmentManager().beginTransaction().replace(R.id.home_container, new ServicesFragment()).commit() ;
            fab.show();
...
/*if (activeFragment != null) {
        ...
        Log.i("HomeActivity", "BackStackEntryCount: " + supportFragmentManager.getBackStackEntryCount());
    }
...
/*boolean background = ActivityLifecycleHandler.isApplicationVisible();
        ...
        if (!Utils.isInternetAvailable(this)) {
            String errorMessage = getResources().getString(com.applozic.mobicomkit.uiwidgets.R.string.internet_connection_not_available);
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == LOCATION_SERVICE_ENABLE) {
            if (((LocationManager) getSystemService(Context.LOCATION_SERVICE))
                ...
                Toast.makeText(c, com.applozic.mobicomkit.uiwidgets.R.string.unable_to_fetch_location, Toast.LENGTH_LONG).show();
            }
            return;
        }
    }
        ...
        if (!((LocationManager) getSystemService(Context.LOCATION_SERVICE))
            ...
            builder.setTitle(com.applozic.mobicomkit.uiwidgets.R.string.location_services_disabled_title)
                    ...
                    .setNegativeButton(android.R.string.cancel, new DialogInterface.OnClickListener() {
                        public void onClick(DialogInterface dialog, int id) {
                            dialog.cancel();
                            Toast.makeText(c, com.applozic.mobicomkit.uiwidgets.R.string.location_sending_cancelled, Toast.LENGTH_LONG).show();
                        }
                    });
    ...
    public void onConnected(Bundle bundle) {
        try {
            ...
            if (mCurrentLocation == null) {
                Toast.makeText(this, com.applozic.mobicomkit.uiwidgets.R.string.waiting_for_current_location, Toast.LENGTH_SHORT).show();
